...
<body>
    ...
    <div class="container">
        ...
        <h1 class="p-3"> Edit Telephone </h1>

        <form:form action="/editSaveTelephone" method="post" modelAttribute="telephone">
                    ...
                    <div class="row">
                    	<div class="form-group col-md-12">
                    		<label class="col-md-3" for="batteryCapacity">batteryCapacity</label>
                    		<div class="col-md-6">
                    			<form:input type="number" path="batteryCapacity" id="batteryCapacity"
                    				class="form-control input-sm" required="required" />
                    		</div>
                    	</div>
                    </div>
